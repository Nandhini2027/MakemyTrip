                ...
                <div className='nav'>
                    ...
                    <div className='side-div'>
                        ...
                        <div className='dropdown'>
                            ...
                            {/* <button type='search' value='serach'>Apply</button> */}
                        </div>
                    </div>
                </div>
                <div className='main2'>
                    <div className='content'>
                        ...
                        <button className='search-button' value='search' type='search'>SEARCH</button>
                        <div className='explore'>
                            <CgChevronDoubleDown />   Explore More   <CgChevronDoubleDown /></div>
                    </div>
                </div>
